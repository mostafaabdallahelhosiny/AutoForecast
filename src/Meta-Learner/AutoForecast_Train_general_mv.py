...
if __name__ == '__main__':
    ...
    for i in range(0, n_folds):
        ...
        for train_data_name in train_folds_list_mv[i]: ## Append all of the second window performances    
        ...
        for train_data_name in train_folds_list_mv[i]: ## Append all of the third window performances    
        ...
        print(train_Y_mse)
        #train_Y_mse[np.isnan(train_Y_mse)] = 0.015  ## Replacing NAN values with high number 
        #break    
        ...
        for test_idx in range(len(test_folds_list_mv[i])):
            ...
            results_vec_mse_1, results_vec_mape_1, results_vec_smape_1, arr_models = Get_All_Model_Dataset(test_folds_list_mv[i][test_idx], mv_dir_1, 'Uni-var')   
            results_vec_mse_2, results_vec_mape_2, results_vec_smape_2, arr_models = Get_All_Model_Dataset(test_folds_list_mv[i][test_idx], mv_dir_2, 'Uni-var')  
            results_vec_mse_3, results_vec_mape_3, results_vec_smape_3, arr_models = Get_All_Model_Dataset(test_folds_list_mv[i][test_idx], mv_dir_3, 'Uni-var')   
        ...
        for idx in  range(3 * len(test_folds_list_mv[i])):
