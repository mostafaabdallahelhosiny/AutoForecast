...
if __name__ == '__main__':
    ...
    for i in range(0, n_folds):
        ...
        for test_data_name in test_folds_list_uv[i]: ## Append all of the first window performances 
            ...
            ## Collect Performances for that dataset (Commented for time since they are not part of inference but to check selected model)
        ...
        for j in range(0, len(test_Y_mse)):
            final_vec_all_folds.append(test_Y_mse.iloc[j,predicted_mse.iloc[j,-1]])
