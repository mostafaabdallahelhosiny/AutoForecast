...
def Get_Best_Avg_Model_Dataset(data_cluster, win_res_dir_name, data_type):
    ...
    return arr_models[best_model_dataset_index_mse_avg], best_model_dataset_index_mse_avg #, best_model_dataset_index_mape_avg, best_model_dataset_index_smape_avg 
...
if __name__ == '__main__':
    ...
    for i in range(0, n_folds): # n_folds
        ...
        for j in range(len(test_folds_list_uv[i])):
                ...
                isac_model_name_mse, isac_model_index_mse = Get_Best_Avg_Model_Dataset(train_rel_cluster, uv_dir_1, 'Uni-var') #
